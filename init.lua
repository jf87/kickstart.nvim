...
-- C-h/j/k/l window navigation is provided by vim-tmux-navigator (lua/custom/plugins/tmux-navigator.lua)
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        ruff = {}, -- Python linting (replaces flake8)
        -- rust_analyzer = {},
        --
...
if vim.g.neovide then
  ...
  vim.api.nvim_set_keymap('n', '<C-=>', ':lua vim.g.neovide_scale_factor = math.min(vim.g.neovide_scale_factor + 0.1,  4.0)<CR>', { silent = true })
...
vim.opt.backupdir = data_path .. '/backup//' -- backup files
